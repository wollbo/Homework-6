...
for j = 1:lim
    [xVec, xhatAll] = kalmanImplement(1, model, testVec(i)*eye(4), x0);
...
%%
close all
fig = figure('Name', 'HomeworkFigures/DifferenceInP02b)_model=' + string(model) + '_lim=' + string(lim))
